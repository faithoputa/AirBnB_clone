...
class TestReview(unittest.TestCase):
    ...
    def test_place_id_attr(self):
        ...
        self.assertEqual(self.review.place_id, None if models.storage_t == 'db' else "")

    def test_user_id_attr(self):
        """Test Review has attr user_id, and it's an empty string"""
        self.assertTrue(hasattr(self.review, "user_id"))
        self.assertEqual(self.review.user_id, None if models.storage_t == 'db' else "")

    def test_text_attr(self):
        """Test Review has attr text, and it's an empty string"""
        self.assertTrue(hasattr(self.review, "text"))
        self.assertEqual(self.review.text, None if models.storage_t == 'db' else "")
    ...
    def test_to_dict_values(self):
        ...
        self.assertEqual(new_d["created_at"], self.review.created_at.strftime(t_format))
        self.assertEqual(new_d["updated_at"], self  
